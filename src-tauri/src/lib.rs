...
pub fn run() {
    ...
    // Linux/webkitgtk 2.4x: o renderer DMABUF derruba o WebKitWebProcess em muitos
    // drivers, VMs e GPUs (sintoma: janela em branco). Desligamos por padrão,
    // respeitando override do usuário. (NÃO mexer em COMPOSITING_MODE/LIBGL aqui —
    // sobre RDP isso quebrou a renderização inteira; ver histórico.)
    #[cfg(target_os = "linux")]
